...
import com.hui.config.interceptor.AuthInterceptor;
import com.hui.config.interceptor.LoginInterceptor;
...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    private static final String[] swaggerStr = {"/**/webjars/**", "/**/swagger-resources/**",  "/**/v2/**", "/**/swagger-ui.html/**"};
    ...
    private void addAuthInterceptor(InterceptorRegistry registry){
        registry.addInterceptor(authInterceptor())
                ...
                .excludePathPatterns(swaggerStr);
    }
